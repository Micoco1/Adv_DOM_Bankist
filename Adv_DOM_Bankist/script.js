...
//   if(window.scrollY > initialCoord.top) nav.classList
//   .add('sticky');
...
// Creatingg and inserting elements
//.insertAdjacentHTML

const message = document.createElement('div');
message.classList.add('cookie-message');
message.textContent = 'We use cooked for improved functionality and anaytics'
message.innerHTML = 'We use cooked for improved functionality and anaytics.<button class = "btn btn--close--cookie">Got it!</button>  '
...
console.log(message.style.color); // doesnt work, style only works in inlight elements
console.log(message.style.backgroundColor);

console.log(getComputedStyle(message).height); // contains all prprties and values
...
// Dont use it will overide all classes
...
// Goinf upwards : Parenst elements
...
[...h1.parentElement.children].forEach(function(el) {
  if(el !== h1) el.style.transform = 'sclae(0.5)';
})
